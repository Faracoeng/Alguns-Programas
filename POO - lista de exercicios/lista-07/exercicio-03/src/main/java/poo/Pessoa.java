...
// Metodos
    ...
    public int compareTo(Pessoa pessoa) {
        //Comparar nome primeiro
        if(this.nome.compareTo(pessoa.nome) > 0){
            return 1;
        }else if(this.nome.compareTo(pessoa.nome) == 0){
            //comparar sobrenome
            if(this.sobrenome.compareTo(pessoa.sobrenome) > 0){
                return 1;
            }else if(this.sobrenome.compareTo(pessoa.sobrenome) == 0){
                if(this.dataNascimento.compareTo(pessoa.dataNascimento) > 0){
                    return 1;
                }else if(this.dataNascimento.compareTo(pessoa.dataNascimento) < 0){
                    return -1;
                }else return 0;
            }else return -1;
        }else return -1;
